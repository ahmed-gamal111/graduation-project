...
<div class="content2">
    ...
    <div style="width: 55%;margin: auto;padding: 22px;height:320px" class="well well-sm center">
      ...
      <h4 style="color: #03954C;">اعدادات النظام</h4>
      <br>
      <form method="POST" class="card" style="background-color:aliceblue;border-radius: 20px;border-color: #03954C;"><br>
         <div class="form-group">
            <label for="some" class="col-form-label"><h5> عنوان النظام </h5></label>
            <input type="text" name="title" style="width: 80%;margin-left: 60px;" class="form-control" value="<?php echo siteTitle() ?>" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label" > <h5>اسم النظام</h5></label>
            <input type="text" name="name" style="width: 80%;margin-left: 60px;" value="<?php echo siteName() ?>" class="form-control" id="some"  required>
          </div> 
          <br>
          <div class="center">
            <button class="btn btn-success " style="width: 100px;" name="saveSetting">حفظ</button>
          </div>   <br>
        </form>
    </div>
</div>
