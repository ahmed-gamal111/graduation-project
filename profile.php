    ...
    <div class="container">
        ...
        <div class="content2">
            ...
            <div style="width: 55%;margin: auto;padding: 22px;height: 320px;" class="well well-sm center">
                ...
                <h4 style="color: #03954C;">اعدادات الملف الشخصي</h4>
                <br>
                <form method="POST" class="card"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" style="width: 80%;margin-left: 60px;" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="number" style="width: 80%;margin-left: 60px;"
                            value="<?php echo $user['number'] ?>" class="form-control" required>
                    </div>
                    <br>
                    <div class="center">
